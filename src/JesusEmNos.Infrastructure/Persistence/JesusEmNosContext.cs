...
namespace JesusEmNos.Infrastructure.Persistence
{
    public class JesusEmNosContext : DbContext
    {
        private readonly DatabaseConfigurationOptions _databaseConfigurationOptions;

        public JesusEmNosContext(DbContextOptions<JesusEmNosContext> options, IOptions<DatabaseConfigurationOptions> databaseConfigurationOptions)
        : base(options)
        {
