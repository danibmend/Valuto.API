...
namespace Valuto.Domain.Entities
{
    public class Pessoa : BaseEntity
    {
        ...
        public List<PessoaContato> Contatos { get; set; } = new();
        ...
        public Pessoa(string nome, string cpf, DateTime dataNascimento, long sexoId, long enderecoId, long igrejaId, string? urlFoto = null)
        {
            Nome = nome;
            Cpf = cpf;
