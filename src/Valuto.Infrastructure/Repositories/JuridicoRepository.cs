...
{
    public class JuridicoRepository : BaseRepository<Juridico>, IJuridicoRepository
    {
        public JuridicoRepository(IServiceProvider serviceProvider) : base(serviceProvider) { }
    }
}
