...
{
    public class ParceiroRepository : BaseRepository<Parceiro>, IParceiroRepository
    {
        public ParceiroRepository(IServiceProvider serviceProvider) : base(serviceProvider) { }
    }
}
