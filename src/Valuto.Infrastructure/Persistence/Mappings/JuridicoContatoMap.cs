...
{
    internal class JuridicoContatoMap : BaseEntityMap<JuridicoContato>
    {
        protected override void ConfigureMapping(EntityTypeBuilder<JuridicoContato> builder)
        {
            ...
            builder.HasOne(e => e.Juridico)
                .WithMany(p => p.Contatos)
                .HasForeignKey(e => e.JuridicoId)
